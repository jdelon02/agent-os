...
4. Load cross-project analysis patterns using consolidated project knowledge graph
5. Set up smart document caching and context compression with canonical naming
```

### 2. Canonical Context & Pattern Retrieval
```
1. Search Memento for similar product analysis patterns using canonical project identity
2. Load Memory-Keeper context from previous sessions across all project aliases
3. Consolidate analysis history from fragmented project name variations
4. Cache frequently accessed documents with canonical reference tracking
...
```
1. Create checkpoint before major analysis conclusions
2. Save findings during investigation phases
3. Document what actually works vs what should theoretically work
4. Preserve analysis artifacts and decision rationale
```
...
- **Architecture Evolution**: Track major architectural changes and their outcomes
- **Technology Decisions**: Understand rationale behind previous technology choices
- **Development Patterns**: Identify successful patterns and anti-patterns
- **Performance Trends**: Monitor system performance and optimization efforts over time
